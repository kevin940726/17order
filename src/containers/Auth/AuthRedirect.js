...
import { redirectUri } from '../../components/SlackSignInButton';
...
class AuthRedirect extends Component {
  ...
  componentDidMount() {
    ...
    fetch(`https://41mmepe4yc.execute-api.ap-northeast-1.amazonaws.com/latest/auth?code=${code}&redirectUri=${redirectUri}`)
      .then(res => res.json())
      .then(async (auth) => {
